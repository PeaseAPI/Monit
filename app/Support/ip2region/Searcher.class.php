...
/**
 * ip2region v2.x 官方 PHP 查询实现（上游 binding/php/xdb/Searcher.class.php，Apache-2.0）
 *
 ...
 * 仅做原样引入（保留原命名空间 ip2region\xdb，避免 PSR-4 与全局类名冲突），
 * 由 App\Support\Ip2Region 在运行时 require_once 后使用。
 *
 * 数据库：data/ip2region_v4.xdb（IPv4，约 11MB，国内 IP 中文省/市/ISP，
 * 格式「国家|省份|城市|ISP|国家码」，如 中国|北京市|北京市|电信|CN）。
 * 本项目在 app/Support/ip2region/ 下原样维护，升级随上游覆盖该文件即可。
 */
