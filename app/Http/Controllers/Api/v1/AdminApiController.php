...
class AdminApiController extends Controller
{
    ...
    public function getWebsite(int $id): JsonResponse
    {
        return response()->json(Website::with('user')->findOrFail($id));
    }
    ...
    {
        return response()->json(Plan::orderBy('order')->get());
    }
    ...
    {
        return response()->json(Payment::with('user')->findOrFail($id));
    }

    public function getSettings(): JsonResponse
    {
        return response()->json(Setting::all()->groupBy(fn ($i) => explode('.', $i->key)[0]));
    }
