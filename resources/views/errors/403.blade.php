...
<div class="flex min-h-[60vh] flex-col items-center justify-center text-center px-6">
    <h1 class="text-9xl font-bold text-zinc-300">403</h1>
    <h2 class="mt-4 text-2xl font-bold text-zinc-900">{{ __('errors.403_title') }}</h2>
    <p class="mt-2 text-zinc-500">{{ __('errors.403_desc') }}</p>
    <div class="mt-8">
