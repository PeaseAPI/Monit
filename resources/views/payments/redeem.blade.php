...
<div class="p-8 max-w-xl">
    ...
    <form method="POST" action="{{ route('payments.redeem.submit') }}" class="mt-6 space-y-4">@csrf
        <div>
            ...
            <input type="text" name="code" required placeholder="{{ __('payments.discount_code_placeholder') }}" class="mt-1 w-full rounded-xl border border-zinc-300 px-4 py-2.5 text-sm">
        </div>
