...
<div class="max-w-xl rounded-2xl border border-zinc-200 bg-white p-6">
    ...
    <div class="space-y-4">
        <div><label class="block text-sm font-medium text-zinc-700">{{ __('admin.language_code') }}</label><input type="text" name="code" class="form-input font-mono" required placeholder="zh_CN"></div>
        <div><label class="block text-sm font-medium text-zinc-700">{{ __('admin.language_name') }}</label><input type="text" name="name" class="form-input" required placeholder="简体中文"></div>
