...
<div class="max-w-xl rounded-2xl border border-zinc-200 bg-white p-6">
    ...
    <div class="space-y-4">
        ...
        <div><label class="block text-sm font-medium text-zinc-700">{{ __('admin.plan_price_col') }}</label><input type="number" step="0.01" name="price" class="mt-1 w-full rounded-xl border border-zinc-300 px-4 py-2.5 text-sm" required></div>
        <div><label class="block text-sm font-medium text-zinc-700">{{ __('admin.max_websites') }}</label><input type="number" name="max_websites" value="10" class="mt-1 w-full rounded-xl border border-zinc-300 px-4 py-2.5 text-sm" required></div>
