...
<div class="rounded-2xl border border-zinc-200 bg-white p-6">
    ...
    <div class="grid gap-4 md:grid-cols-2">
        ...
        <div><label class="block text-sm font-medium text-zinc-700">月价（{{ \App\Support\Currency::default() }}）</label><input type="number" step="0.01" name="price" value="{{ old('price', $plan->prices['monthly'] ?? 0) }}" class="mt-1 w-full rounded-xl border border-zinc-300 px-4 py-2.5 text-sm" required></div>
