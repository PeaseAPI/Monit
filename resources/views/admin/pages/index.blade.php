...
<div class="mb-6 flex items-center justify-between">
    ...
    <div class="flex items-center gap-3">
        <a href="{{ route('admin.pages-categories.index') }}" class="rounded-xl border border-zinc-300 px-4 py-2.5 text-sm text-zinc-700 hover:bg-zinc-50">{{ __('admin.pages_categories') }}</a>
    ...
    <tbody class="divide-y divide-zinc-100">
        ...
        <tr>
            ...
            <td class="px-6 py-3 text-right whitespace-nowrap">
                ...
                <form method="POST" action="{{ route('admin.pages.destroy', $p->page_id) }}" class="inline">@csrf @method('DELETE')<button class="text-sm text-red-500 hover:text-red-700" onclick="return confirm(this.dataset.msg)" data-msg="{{ __('common.confirm_delete') }}">{{ __('common.delete') }}</button></form>
            </td>
        </tr>
