...
<div class="p-8">
    ...
    <div class="mt-6 max-w-xl rounded-2xl border border-zinc-200 bg-white p-6">
        ...
        <div><label class="block text-sm font-medium text-zinc-700">{{ 'CSV File' }}</label><input type="file" name="file" accept=".csv" class="mt-1 w-full rounded-xl border border-zinc-300 px-4 py-2.5 text-sm"></div>
