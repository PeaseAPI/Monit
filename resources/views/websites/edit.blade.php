...
@section('title', __('websites.edit_title'))

@section('content')
    <div class="mx-auto max-w-xl">
        <h2 class="text-2xl font-bold">{{ __('websites.edit_title') }}</h2>
        <p class="mt-1 text-sm text-zinc-500">{{ __('websites.edit_desc', ['name' => $website->name]) }}</p>
