...
<div class="max-w-7xl">
    ...
    <div class="max-w-xl rounded-2xl border border-zinc-200 bg-white p-6">
        ...
        <div class="space-y-4">
            <div><label class="block text-sm font-medium text-zinc-700">{{ __('domains.domain_label') }}</label><input type="text" name="name" placeholder="example.com" class="form-input" required></div>
