...
<div class="max-w-7xl">
    ...
    <div class="rounded-2xl border border-zinc-200 bg-white overflow-hidden">
        ...
        <div id="replay-container" class="relative bg-zinc-100" style="min-height:480px" data-events-url="{{ route_path('stats.replays.events', [$website->website_id, $replay->replay_id]) }}">
