...
<div class="p-8">
    ...
    <div class="max-w-xl rounded-2xl border border-zinc-200 bg-white p-6">
        ...
        <div class="space-y-4">
            <div><label class="block text-sm font-medium text-zinc-700">{{ __('stats.heatmap_name_label') }}</label><input type="text" name="name" class="mt-1 w-full rounded-xl border border-zinc-300 px-4 py-2.5 text-sm" required></div>
            <div><label class="block text-sm font-medium text-zinc-700">{{ __('stats.heatmap_path_label') }}</label><input type="text" name="path" placeholder="/homepage" class="mt-1 w-full rounded-xl border border-zinc-300 px-4 py-2.5 text-sm" required></div>
