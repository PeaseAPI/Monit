...
@section('content')
<div class="p-8">
    <div class="mb-6"><a href="{{ route('stats.heatmaps', $website->website_id) }}" class="text-sm text-zinc-500 hover:underline">&larr; {{ __('stats.back_to_heatmap_list') }}</a><h1 class="mt-2 text-2xl font-bold text-zinc-900">{{ $heatmap->name }}</h1></div>
