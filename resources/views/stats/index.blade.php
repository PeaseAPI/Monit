...
<div class="p-8">
    ...
    <div class="mt-4 flex flex-wrap gap-2">
        ...
        <a href="{{ route('stats.outbound_clicks', $website->website_id) }}" class="rounded-lg border border-zinc-200 bg-white px-3 py-1.5 text-sm text-zinc-600 shadow-sm hover:bg-zinc-50">{{ __('stats.nav.outbound_clicks') }}</a>
