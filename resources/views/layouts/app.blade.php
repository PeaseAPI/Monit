                ...
                --}}
                    ...
                    $items = array_merge(
                        ...
                        array_filter([
                            ...
                            // 帮助/工单已上移至顶栏（通知铃铛左侧），不再占用侧栏位（三十八轮）
        ...
        <div class="flex min-h-screen w-full flex-col md:pl-60">
            ...
            <header class="sticky top-0 z-20 flex items-center justify-between border-b border-zinc-200 bg-white/80 px-4 py-3 backdrop-blur md:hidden">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a href="{{ route('help') }}" class="text-sm text-zinc-600">{{ __('nav.help') }}</a>
                    <a href="{{ route('tickets.index') }}" class="text-sm text-zinc-600">{{ __('nav.tickets') }}</a>
